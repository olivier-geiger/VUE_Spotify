          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition"
                ...
                :class="{
                  'hover:text-white text-white bg-gradient-to-r from-green-600 to-green-300': tab === 'login',
                  'hover:text-white-600': tab === 'register'
                }">
                Se connecter
              </a>
            </li>
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition "
                ...
                :class="{
                  'hover:text-white text-white bg-gradient-to-r from-green-600 to-green-300': tab === 'register',
                  'hover:text-white-600': tab === 'login'
                }">S'enregistrer</a>
            </li>
          </ul>
          ...
          <form v-show="tab === 'login'">
            ...
            <button type="submit"
              class="block w-full text-white py-1.5 px-3 rounded transition
                bg-gradient-to-l from-green-600 to-green-300">
              Envoyer
            </button>
          </form>
          <!-- Registration Form -->
